  ...
  const getCategoryInfo = () => {
    ...
    return (
      categoryMap[category || "trending"] || {
        title: "Trending TV Shows",
        description:
          "Browse and filter thousands of TV shows with advanced options",
        icon: Sparkles,
        gradient: "from-orange-500/20 via-red-500/20 to-pink-500/20",
        iconColor: "text-orange-500",
      }
  ...
  return (
    ...
    >
      ...
      <main className="pt-20">
        ...
        <section className="relative mb-10 md:mb-12" data-testid="tv-shows-header">
        ...
        {/* Enhanced TV Shows Grid Section */}
        <section className="pb-20 md:pb-24" data-testid="tv-shows-grid-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {isLoading ? (
              ...
              >
                <div className="w-full max-w-lg text-center">
                  ...
                  <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-md mx-auto">
                    We couldn't find any TV shows matching your criteria. Try
