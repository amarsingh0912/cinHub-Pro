      ...
      <main className="pt-16">
        ...
        <section className="relative py-20 overflow-hidden" data-testid="hero-section">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <RevealOnScroll options={{...REVEAL_PRESETS.fadeIn, delay: 100}}>
              ...
              <RevealOnScroll options={REVEAL_PRESETS.heroTitle}>
              ...
              <RevealOnScroll options={REVEAL_PRESETS.heroSubtitle}>
              ...
              <RevealOnScroll options={{...REVEAL_PRESETS.heroSubtitle, delay: 500}}>
                <p className="text-lg text-muted-foreground/80 mb-12 max-w-2xl mx-auto">
                  From blockbuster hits to hidden gems - your next favorite film is just a click away.
                </p>
              </RevealOnScroll>
              
              <RevealOnScroll options={REVEAL_PRESETS.heroButtons}>
        ...
        <section className="py-20 relative overflow-hidden" data-testid="community-section">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <RevealOnScroll options={{...REVEAL_PRESETS.cardReveal, delay: 400}}>
              <div className="text-center">
