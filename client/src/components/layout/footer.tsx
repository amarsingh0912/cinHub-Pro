  ...
  return (
    <footer className="bg-gradient-to-br from-card to-card/50 border-t border-border/50 relative overflow-hidden" data-testid="footer">
      ...
      <div className="relative">
        {/* Newsletter Section */}
        <div className="border-b border-border/50 animate-fade-in-up">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center max-w-2xl mx-auto animate-slide-up-stagger-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in-up">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 animate-stagger-in">
            {/* Brand Section */}
